            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-wrap px-5">
                    ...
                    <div class="d-flex fw-semibold text-primary fs-base">
                        ...
                        <a href="#" class="px-5" target="_blank">Privacy Policy
                        </a>
                        <a href="#" class="px-5" target="_blank">Get Support
                    </div>
                    <!--end::Links-->
                </div>
                <!--end::Footer-->
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{ image('misc/auth-bg.png') }})">
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <a href="{{ route('dashboard') }}" class="mb-12">
                        <img alt="Logo" src="{{ image('logos/TIMD logo_RGB.png') }}" class="h-60px h-lg-75px"/>
                    </a>
                    <!--end::Logo-->
                    ...
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7">
                        TimD PMS - Property Management Simplified
                    </h1>
                    <!--end::Title-->
                    ...
                    <div class="d-none d-lg-block text-white fs-base text-center">
                        {{-- In this kind of post, <a href="#" class="opacity-75-hover text-warning fw-bold me-1">the blogger</a> --}}
                         ...
                         <br/> Ascend your property management journey to new heights with our streamlined solutions,

                        {{-- <a href="#" class="opacity-75-hover text-warning fw-bold me-1">the interviewee</a> --}}
                         <br/> optimizing operations for unparalleled efficiency and productivity..
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Content-->
