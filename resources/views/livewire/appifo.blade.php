                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <!--begin::Form-->
                                <form id="kt_account_profile_details_form" class="form" wire:submit="submit" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Card body-->
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <label
                                                        ...
                                                        <!--begin::Inputs-->
                                                        <input type="file"  wire:model="logo" name="logo" accept=".png, .jpg, .jpeg" />
                                         ...
                                         <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    <!--begin::Col-->
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="text" name="version" wire:model="version"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Version"  />
                                                            @error('version')
                                                            <span class="text-danger">{{ $message }}</span> 
                                         ...
                                         <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    <!--begin::Col-->
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="text" name="beta_url" wire:model="beta_url"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                         ...
                                         <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    <!--begin::Col-->
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="text" name="playstore_url"  wire:model="playstore_url"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                         ...
                                         <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    <!--begin::Col-->
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="text" name="appstore_url" wire:model="appstore_url"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
