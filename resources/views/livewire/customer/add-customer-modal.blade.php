                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_customer_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" wire:model="phone_number" name="phone_number" id="phone_number"
                                ...
                                {{-- <button type="button" onclick="check_cus()">Check</button> --}}
                            <!--end::Input-->
                            @error('phone_number')
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea wire:model="address" name="address" class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <div class="mb-7">
                            ...
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid mx-5">
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" id="kt_modal_update_role_option_1"
                                ...
                                <div class="form-check form-check-custom form-check-solid mx-5">
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" id="kt_modal_update_role_option_0"
