    ...
    <div class="notice bg-light-warning rounded border-warning border border-dashed p-6 tab_content " data-kt-stepper-element="content"
        ...
        <div class="row row-cols-md-2">
            ...
            <div class="col d-flex flex-stack flex-grow-1">
                <div class="fw-semibold">
                    ...
                    <h4 class="text-gray-900 fw-bold" id="booked_rooms"></h4>
                </div>
            </div>
            <div class="col d-flex flex-stack flex-grow-1">
                <div class="fw-semibold">
